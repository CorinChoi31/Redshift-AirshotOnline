...
global.particle[? "Unit.Move.Trail.Self"] = part_type_create();
    _particle = global.particle[? "Unit.Move.Trail.Self"];
    part_type_shape(_particle, pt_shape_square);
...
global.particle[? "Unit.Move.Trail.Enemy"] = part_type_create();
    _particle = global.particle[? "Unit.Move.Trail.Enemy"];
    part_type_shape(_particle, pt_shape_square);
    part_type_size(_particle, 0.05, 0.35, -0.0025, 0);
    part_type_scale(_particle, 1, 1);
    part_type_orientation(_particle, 0, 360, 0, 0, true);
